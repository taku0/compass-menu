 ...
 */
async function searchWeb({searchText, useNewTab}) {
    // TODO use preferred search engine.
    const url = `http://www.google.com/search?q=${searchText}`;

    if (useNewTab) {
        return await openURLInNewTab({ url });
    } else {
